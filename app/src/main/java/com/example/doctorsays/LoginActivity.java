...
//    public void startDoctorSaysUserLoginActivity(View view) {
//        Intent intent = new Intent(this, DoctorSaysUserLoginActivity.class);
//        startActivity(intent);
//        LoginActivity.this.finish();
//    }
//
//    public void startDoctorSaysRegistrationActivity(View view) {
//        Intent intent = new Intent(this, DoctorSaysRegistrationActivity.class);
//        startActivity(intent);
//        LoginActivity.this.finish();
//    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Toast.makeText(LoginActivity.this, "Authentication went worng!!!", Toast.LENGTH_SHORT).show();
                // ...
            }
        }
    }
